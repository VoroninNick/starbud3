class PublicationsController < ApplicationController
  ...
  def helpful_articles
    ...
    @helpful_article_banner = PublicationBanner.order('index_sorting asc').limit(3)
  end
  ...
  private
    ...
    def publication_params
      params.require(:publication).permit(:title, :image, :short_description, :description, :url)
    end
end
